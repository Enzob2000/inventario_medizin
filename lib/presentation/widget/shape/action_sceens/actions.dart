...
class Menuaction extends ConsumerWidget {
  ...
  Menuaction({super.key, required this.icon, required this.action, required this.namescreen, required this.index});
  ...
  Widget build(BuildContext context, ref) {
    ...
    final colortext=menuindex==index?const Color(0xFFFFFFFF):const Color(0xFF434343);

    final colorbackgroud=menuindex==index?colorScheme:const Color(0xFFFFFFFF);
...
final List<MenuItem> menuauxil = [
  ...
  MenuItem(
    icon: "assets/icons/Icon_reporte.svg",
    action: "Reporte",
    index: 7,
  ),
